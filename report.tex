...
The oligonucleotide qPCR primers were obtained from Ensembl\textsuperscript{\protect\hyperlink{ref-howe2020}{1}} (Table \ref{tab:primers}).
...
\multirow{-2}{*}{\raggedright\arraybackslash AXIN} & R & TGTCACTTACTTTTTCTGTGGGGA\\

 & L & NA\\

\multirow{-2}{*}{\raggedright\arraybackslash HPRT1} & R & NA\\

 & L & NA\\

\multirow{-2}{*}{\raggedright\arraybackslash KLF2} & R & NA\\
...
\CSLLeftMargin{1. }
\CSLRightInline{Howe, K. L. \emph{et al.} Ensembl 2021. \emph{Nucleic Acids Research} \textbf{49}, D884--D891 (2020).}
