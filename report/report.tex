...
\caption{\label{fig:results}Relative mRNA expression of angiopoeitin-2, axin-2, and thrombospondin-1 from HUVECs exposed to high and low oscillatory shear stress (OSS). Normalised to the HPRT control and relative to the static control.}
\end{figure}
