...
\begin{figure}
\centering
\includegraphics{report_files/figure-latex/results-1.pdf}
\caption{\label{fig:results}Relative to HPRT control.}
\end{figure}
